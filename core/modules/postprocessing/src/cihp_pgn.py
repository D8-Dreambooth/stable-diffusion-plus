...
# TODO: Load this path from modelhandler
...
def main():
    ...
    image_batch050 = tf.image.resize(image_batch, [tf.cast(h_orig * 0.50, tf.int32), tf.cast(w_orig * 0.50, tf.int32)])
    image_batch075 = tf.image.resize(image_batch, [tf.cast(h_orig * 0.75, tf.int32), tf.cast(w_orig * 0.75, tf.int32)])
    image_batch125 = tf.image.resize(image_batch, [tf.cast(h_orig * 1.25, tf.int32), tf.cast(w_orig * 1.25, tf.int32)])
    image_batch150 = tf.image.resize(image_batch, [tf.cast(h_orig * 1.50, tf.int32), tf.cast(w_orig * 1.50, tf.int32)])
    image_batch175 = tf.image.resize(image_batch, [tf.cast(h_orig * 1.75, tf.int32), tf.cast(w_orig * 1.75, tf.int32)])
