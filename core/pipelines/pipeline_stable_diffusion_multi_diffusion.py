...
from diffusers.utils import randn_tensor, deprecate, is_accelerate_available, is_accelerate_version
from packaging import version
from transformers import CLIPTextModel, CLIPTokenizer, logging, CLIPImageProcessor
from diffusers import AutoencoderKL, UNet2DConditionModel, DDIMScheduler, DiffusionPipeline
...
class StableDiffusionMultiDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    r"""
    ...
    @torch.no_grad()
    def __call__(self, masks, prompts, negative_prompts='', height=512, width=2048, num_inference_steps=50,
