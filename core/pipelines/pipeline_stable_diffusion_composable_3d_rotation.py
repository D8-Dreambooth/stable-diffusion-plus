...
class StableDiffusionComposable3dRotationPipeline(DiffusionPipeline, PipelineOptimMixin):
    r"""
    ...
    def __call__(
        ...
        logging.getLogger(__name__).debug(f"Getting prompt embeddings: {prompt}")
